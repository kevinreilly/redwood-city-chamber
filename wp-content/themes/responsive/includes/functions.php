...
function responsive_read_more() {
    return '<div class="read-more"><a href="' . get_permalink() . '">' . __('', 'responsive') . '</a></div><!-- end of .read-more -->';
}
...
function responsive_breadcrumb_lists() {
    ...
    function responsive_widgets_init() {
        ...
        register_sidebar(array(
            'name' => __('Membership Sidebar', 'responsive'),
            'description' => __('Area 3 - sidebar-membership.php', 'responsive'),
        ...
        register_sidebar(array(
            'name' => __('Leadership Sidebar', 'responsive'),
            'description' => __('Area 3 - sidebar-leadership.php', 'responsive'),
            'id' => 'leadership-sidebar',
            'before_title' => '<div class="widget-title">',
            'after_title' => '</div>',
            'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
            'after_widget' => '</div>'
